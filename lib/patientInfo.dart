      ...
      child: new Center(
        child: new ListView(
          children:[
            ...
            new PatientItem('Address',_dataOfUser["domicilio"], Icons.location_city),
            new PatientItem('DNI',_dataOfUser["dni"], Icons.card_membership),
            new PatientItem('Clinic History',_dataOfUser["numero_de_hc"], Icons.confirmation_number),
            new PatientItem('Gender',_dataOfUser["sexo"], Icons.person_add),
